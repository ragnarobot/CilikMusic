...
import os
from os import path
from CilikMusic.Utils.helpers.thumbnails import down_thumb
from CilikMusic import app
from CilikMusic.Utils.helpers.inline import others_markup, play_markup
    ...
    if j == 0:
        ...
        key = InlineKeyboardMarkup(
            [
                ...
                [
◀️                    InlineKeyboardButton(text="🗑 ᴄʟᴏꜱᴇ", callback_data=f'close2')
                ]    
            ]
        )    
    elif j == 5:
