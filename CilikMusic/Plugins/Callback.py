...
from CilikMusic.Utils.tgcallsrun import ASS_ACC
from os import path
import random
...
from CilikMusic.Utils.tgcallsrun import (music, convert, download, clear, get, is_empty, put, task_done, smexy)
from CilikMusic.Utils.helpers.decorators import errors
from CilikMusic.Utils.helpers.filters import command, other_filters
from CilikMusic.Utils.helpers.paste import paste
from CilikMusic.Utils.tgcallsrun import (music, clear, get, is_empty, put, task_done)
from CilikMusic.Utils.database.queue import (is_active_chat, add_active_chat, remove_active_chat, music_on, is_music_playing, music_off)
from CilikMusic.Utils.database.playlist import (get_playlist_count, _get_playlists, get_note_names, get_playlist, save_playlist, delete_playlist)
from CilikMusic.Utils.database.assistant import (_get_assistant, get_assistant, save_assistant)
from CilikMusic.Utils.helpers.inline import (play_keyboard, search_markup, play_markup, playlist_markup, audio_markup)
from CilikMusic.Utils.helpers.inline import play_keyboard, confirm_keyboard, play_list_keyboard, close_keyboard, confirm_group_keyboard
from CilikMusic.Utils.tgcallsrun import (music, convert, download, clear, get, is_empty, put, task_done, smexy)
from CilikMusic.Utils.database.queue import (is_active_chat, add_active_chat, remove_active_chat, music_on, is_music_playing, music_off)
from CilikMusic.Utils.database.onoff import (is_on_off, add_on, add_off)
from CilikMusic.Utils.database.blacklistchat import (blacklisted_chats, blacklist_chat, whitelist_chat)
from CilikMusic.Utils.database.gbanned import (get_gbans_count, is_gbanned_user, add_gban_user, add_gban_user)
from CilikMusic.Utils.database.theme import (_get_theme, get_theme, save_theme)
from CilikMusic.Utils.database.assistant import (_get_assistant, get_assistant, save_assistant)
from config import DURATION_LIMIT, ASS_ID
from CilikMusic.Utils.helpers.decorators import errors
from CilikMusic.Utils.helpers.filters import command
from CilikMusic.Utils.helpers.gets import (get_url, themes, random_assistant, ass_det)
...
from CilikMusic.Utils.helpers.inline import (play_keyboard, search_markup, play_markup, playlist_markup)
import requests
from pyrogram.types import (
    CallbackQuery,
    InlineKeyboardButton,
